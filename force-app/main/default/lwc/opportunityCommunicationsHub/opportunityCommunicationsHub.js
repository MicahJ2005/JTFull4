/**
 * opportunityCommunicationsHub.js
 *
 * Unified communications hub for Opportunity records.
 ...
 *
 * Data source: OpportunityCommunicationsController.getCommunications()
 *              OpportunityCommunicationsController.getEmailBody()
 *
...
import getCommunications                from '@salesforce/apex/OpportunityCommunicationsController.getCommunications';
import getEmailBody                     from '@salesforce/apex/OpportunityCommunicationsController.getEmailBody';
...
export default class OpportunityCommunicationsHub extends LightningElement {

    @api recordId;  // Opportunity Id — injected by Lightning record page
    ...
    async confirmUnrelate() {
        ...
        try {
            ...
            this.dispatchEvent(new ShowToastEvent({
                title  : 'Done',
                message: 'Email unrelated from this opportunity.',
                variant: 'success'
            }));
            this.selectedItem      = null;
            this._selectedKey      = null;
